...
$spreads = [
    ...
    'Celtic Cross'   => ['label' => 'Ten Cards (Current Situation, Obstacle, Goal, Past, Near Future, The Querent, Influences, Environment, Hopes and Fears, Final Outcome)', 'count' => 10]
];
...
<head>
    <meta charset="UTF-8">
    <title>Tarot Card Reading - Public Access</title>
<style>
...
<p>
This Tarot application is currently in beta testing.
<p>
Comments and suggestions are welcome.
<a href="mailto:Spirit.Bill.L@gmail.com?subject=Comment%20on%20your%20Tarot%20application&body=My%20comment%20is:">
Send me an Email</a>
</p>
<script data-name="BMC-Widget" data-cfasync="false" src="https://cdnjs.buymeacoffee.com/1.0.0/widget.prod.min.js" data-id="spiritbillie" data-description="Support me on Buy me a coffee!" data-message="Thank you for visiting." data-color="#5F7FFF" data-position="Right" data-x_margin="18" data-y_margin="18"></script>
</p>
...
<?php foreach ($reading_results as $index => $card): ?>
    <div class="tarot-card">
        ...
        <h3>Position <?php echo $index + 1; ?></h3>
